...
test_that("t_HT, Horvitz-Thompson Mean Estimator", {
...
test_that("var_t_HT, Horvitz-Thompson Variance Estimator", {
	# Ch. 24, Exercise #2, p. 307, from Thompson (2002)
...
test_that("R_hat, Horvitz-Thompson Ratio Estimator, and var_R_hat, both with replacement; R_hat without replacement", {
